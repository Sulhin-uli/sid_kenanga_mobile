...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2021 at 05:38 PM
...
--
-- Table structure for table `gambar_lp`
--

CREATE TABLE `gambar_lp` (
  `id` int(11) NOT NULL,
  `gambar` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `gambar_lp`
--

INSERT INTO `gambar_lp` (`id`, `gambar`) VALUES
(1, '1.png'),
(2, '2.png'),
(3, '3.png'),
(4, '4.png'),
...
--
-- Table structure for table `jumlah_notif`
--

CREATE TABLE `jumlah_notif` (
  `id_jumlah_notif` int(11) NOT NULL,
...
(34, 'Lorem Ipsum', '2021-07-03', 'Lorem Ipsum.png', 'dad'),
(35, 'Lorem Ipsum', '2021-06-09', 'Lorem Ipsum.jpg', 'gdsest');
...
INSERT INTO `notifikasi` (`id_notifikasi`, `nik`, `nama`, `aksi`, `status`, `alasan`) VALUES
(92, '1234567', 'Andri', 'Permintaan Surat Keterangan Usaha', 'Dilihat', NULL),
(93, '1234567', 'Andri', 'Mengirim Pesan Aduan', 'Dilihat', NULL),
(94, '1234567', 'Andri', 'Permintaan Surat Keterangan Usaha', 'Dilihat', NULL),
(95, '1234567', 'Andri', 'Membatalkan Pembuatan Surat Keterangan Usaha', 'Dilihat', 'tes');
...
(65, 'Andri', '1234567', 'Indonesia', '06-06-2021', 'aesasasas', 'Dilihat', '2021-06-06 02:44:17', '2021-06-06 02:44:17');
...
CREATE TABLE `permintaan_surat` (
  ...
  `text9` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text10` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text11` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text12` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text13` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text14` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text15` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text16` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text17` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text18` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text19` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text20` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `permintaan_surat` (`id_permintaan_surat`, `nik`, `nama_penduduk`, `nama_surat`, `status`, `tgl`, `created_at`, `updated_at`, `text1`, `text2`, `text3`, `text4`, `text5`, `text6`, `text7`, `text8`, `text9`, `text10`, `text11`, `text12`, `text13`, `text14`, `text15`, `text16`, `text17`, `text18`, `text19`, `text20`) VALUES
(35, '1234567', 'Andri', 'Surat Keterangan Usaha', 'Diproses', '06-06-2021', '2021-06-06 02:12:38', '2021-06-06 02:12:38', 'Nama Usaha :', 'Nama Pemohon :', 'Tempat Lahir :', 'Tanggal Lahir :', 'Jenis Kelamin :', 'Agama :', 'Status :', 'Kewarganegaraan :', 'Pekerjaan :', 'Alamat :', 'Nama Usaha :', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(101, 'App\\Models\\User', 5, 'my-app-token', '6ec94babba218222e14ca4fde713301266bbbd09292dac5ea16c5be33f44603b', '[\"*\"]', NULL, '2021-05-27 17:23:18', '2021-05-27 17:23:18'),
(102, 'App\\Models\\User', 5, 'my-app-token', '2129f1acc475ebb1e538f9f08ec3640d2fc31d3664eaff35e00a39e71e988045', '[\"*\"]', NULL, '2021-05-27 21:12:31', '2021-05-27 21:12:31'),
(103, 'App\\Models\\User', 5, 'my-app-token', 'db5102280bea65072e924f846b0ebbb7373fedf3d098afe40c8861b0eaf0b908', '[\"*\"]', NULL, '2021-05-29 08:38:28', '2021-05-29 08:38:28'),
(104, 'App\\Models\\User', 5, 'my-app-token', 'c88daccd0e7b0b724fb5c545543c520646b7e4b11bf21d45725045080f6d6efd', '[\"*\"]', NULL, '2021-05-29 08:40:37', '2021-05-29 08:40:37'),
(105, 'App\\Models\\User', 5, 'my-app-token', 'fee72d635f538fecafb1b522d67f5ab16d8da4b37ef7d2504db26af518d857d3', '[\"*\"]', NULL, '2021-05-29 08:41:49', '2021-05-29 08:41:49'),
(106, 'App\\Models\\User', 5, 'my-app-token', 'cf9bb80e076d263f3e0eb1e9ccd3cd8733832ef71e7bf70df3fcd3df5bcb7db8', '[\"*\"]', NULL, '2021-05-29 09:50:34', '2021-05-29 09:50:34'),
(107, 'App\\Models\\User', 5, 'my-app-token', '240590f5266b2b03bbe794cb585d8668d64984eee4e6b6dee5b42a3bd79eb388', '[\"*\"]', NULL, '2021-05-29 09:50:55', '2021-05-29 09:50:55'),
(108, 'App\\Models\\User', 5, 'my-app-token', '06cad31bd59a350e4a3408a7ab13dd0a9430baf19e1fc68400b8a379d3c940c6', '[\"*\"]', NULL, '2021-05-29 16:48:43', '2021-05-29 16:48:43'),
(109, 'App\\Models\\User', 5, 'my-app-token', 'fe2049b750d11282df53634ab79ee821cb3079f5fcfb5a5d4bb6c09057a2d5c9', '[\"*\"]', NULL, '2021-05-29 16:48:50', '2021-05-29 16:48:50'),
(110, 'App\\Models\\User', 5, 'my-app-token', '23e925cb5e32af24a77c1782120f0ac3b16fd3b85d9592c3d5bc23d32637478d', '[\"*\"]', NULL, '2021-05-29 18:22:43', '2021-05-29 18:22:43'),
(111, 'App\\Models\\User', 5, 'my-app-token', '34ece768099823ea017f9a2a49840a8852be30f4982cccd4ed439fcaf31b9dfb', '[\"*\"]', NULL, '2021-05-29 21:19:13', '2021-05-29 21:19:13'),
(112, 'App\\Models\\User', 5, 'my-app-token', 'cfc524308a01a51e049be8c9f50d4442ef3744dfa65dd5be45ca732d1dbd566d', '[\"*\"]', NULL, '2021-05-30 03:02:29', '2021-05-30 03:02:29'),
(113, 'App\\Models\\User', 10, 'my-app-token', '8e4fe46d0fe3e2427ab12401b3be9442378297d67c449a7bd37901854334929b', '[\"*\"]', NULL, '2021-06-01 18:28:18', '2021-06-01 18:28:18'),
(114, 'App\\Models\\User', 11, 'my-app-token', '05a82ef072c4111d6747a96298921c95cd391d464fe3ae8faccc74d4929b68d0', '[\"*\"]', NULL, '2021-06-02 07:07:43', '2021-06-02 07:07:43'),
(115, 'App\\Models\\User', 10, 'my-app-token', '8996f7d508aa4e2ede03e902cdfde682518e8a6c7581c4b5280ed9ea034e5425', '[\"*\"]', NULL, '2021-06-02 07:08:42', '2021-06-02 07:08:42'),
(116, 'App\\Models\\User', 11, 'my-app-token', '53265545f2bb17d0273787ac1e37faa21edcbc1f5076dc4429b9bbe79651a22d', '[\"*\"]', NULL, '2021-06-02 07:13:40', '2021-06-02 07:13:40'),
(117, 'App\\Models\\User', 10, 'my-app-token', '6cbdfb8f7e0dd26c92f2b44d3f1912b642065000c6d27e24e78b52d06ebbf9b5', '[\"*\"]', NULL, '2021-06-02 07:17:33', '2021-06-02 07:17:33'),
(118, 'App\\Models\\User', 11, 'my-app-token', 'ee379763b14a74958a5b476dcbe43e56e085317c1679bedcab269049b01e453b', '[\"*\"]', NULL, '2021-06-02 07:18:26', '2021-06-02 07:18:26'),
(119, 'App\\Models\\User', 10, 'my-app-token', '2ee6316668f0514be501f31497e9e13a6155855f022369708f1c5350874254c4', '[\"*\"]', NULL, '2021-06-05 19:59:45', '2021-06-05 19:59:45'),
(120, 'App\\Models\\User', 10, 'my-app-token', '8455db1f5742869809d7eb18425353b280441b273983e16f538349c945e1f401', '[\"*\"]', '2021-06-05 23:34:27', '2021-06-05 23:01:01', '2021-06-05 23:34:27'),
(121, 'App\\Models\\User', 10, 'my-app-token', '90d5f90a9363f23aa0bf33cd4a689aea7229da816b3f629087d06494583f1f7a', '[\"*\"]', NULL, '2021-06-05 23:46:19', '2021-06-05 23:46:19'),
(122, 'App\\Models\\User', 10, 'my-app-token', '69652b5365385c702bfe5baabad2d6a81789a80515db73a1e01c2aa5ecd9340b', '[\"*\"]', NULL, '2021-06-06 02:09:12', '2021-06-06 02:09:12');
...
(2, 'Surat Keterangan Domisili CV', 'surat_keterangan_domisili'),
...
INSERT INTO `users` (`id`, `nik`, `name`, `alamat`, `no_hp`, `email`, `email_verified_at`, `pin`, `password`, `is_admin`, `remember_token`, `created_at`, `updated_at`) VALUES
(2, NULL, 'Sulhin Ratwi', NULL, NULL, 'sulhinhin8@gmail.com', NULL, NULL, '$2y$10$d939Nk7i.C7Q0crLlexItOIrdacVMc18qHePu9ecx5PoQZjnCuP5K', '1', 'KCypjLQLsdj6A4EjiKzaqdVUtMj8uuKIxBXjvpY0XeeTzd830hlzw0AFWFXs', '2021-04-02 21:56:32', '2021-05-19 05:50:19'),
(4, NULL, 'Admin', NULL, NULL, 'admin@admin', NULL, NULL, '$2y$10$cKcDSQNIemCvpo9LRsUdvui8nBJg2hV7I29UMuXLZIkHhNcSnoMhe', '1', NULL, '2021-05-13 19:44:38', '2021-05-13 19:44:38'),
(10, 1234567, 'Andri', 'Indonesia', '1234567890', NULL, NULL, 123456, NULL, '0', NULL, NULL, NULL);
...
--
-- Indexes for table `gambar_lp`
--
ALTER TABLE `gambar_lp`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `jumlah_notif`
--
ALTER TABLE `jumlah_notif`
  ADD PRIMARY KEY (`id_jumlah_notif`);
...
--
ALTER TABLE `aparaturdesa`
  MODIFY `id_aparaturdesa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- AUTO_INCREMENT for table `gambar_lp`
--
ALTER TABLE `gambar_lp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `jumlah_notif`
--
ALTER TABLE `jumlah_notif`
  MODIFY `id_jumlah_notif` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `kabar_desa`
--
ALTER TABLE `kabar_desa`
  MODIFY `id_kabar_desa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `notifikasi`
  MODIFY `id_notifikasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
...
--
ALTER TABLE `pengaduan`
  MODIFY `id_pengaduan` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;

--
-- AUTO_INCREMENT for table `permintaan_surat`
--
ALTER TABLE `permintaan_surat`
  MODIFY `id_permintaan_surat` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
